let a = [
  "",
...
function hack() {
  ...
  const hackapi = async function () {
    ...
    let step9 = await new Promise((resolve, reject) => {
      setTimeout(() => {
        text[5].innerHTML = "hacking status: hacked! succesfully ";
        resolve(1);
...
let hehe = document.getElementsByClassName('main');
console.log(hehe);